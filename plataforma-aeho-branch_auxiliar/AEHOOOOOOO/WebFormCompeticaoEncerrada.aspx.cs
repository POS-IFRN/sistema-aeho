...
{
    public partial class WebFormCompeticaoEncerrada : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select id, nome, descricao, modalidade, foto_da_competicao from Competicao where status_competicao = 2", conn);
            conn.Open();
