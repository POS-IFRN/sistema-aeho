<%@ Page Title="" Language="C#" MasterPageFile="~/MasterOrganizador.Master" AutoEventWireup="true" CodeBehind="WebFormEditarCompete.aspx.cs" Inherits="AEHOOOOOOO.WebFormEditarCompete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td>
                        <div class="ls-label col-md-3">
                            ...
                            <asp:TextBox ID="TextBoxInicio" runat="server" Class="datepicker" Width="400"></asp:TextBox>
                        </div>
                    </td>
                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Esse campo não pode ficar em branco" ControlToValidate="TextBoxInicio" SetFocusOnError="True" Display="Static" Font-Bold="True" ForeColor="Red"> </asp:RequiredFieldValidator></td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="ls-label col-md-3">
                            ...
                            <asp:TextBox ID="TextBoxEncerramento" runat="server" Class="datepicker" Width="400"></asp:TextBox>
                        </div>
                    </td>
                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Esse campo não pode ficar em branco" ControlToValidate="TextBoxEncerramento" SetFocusOnError="True" Display="Static" Font-Bold="True" ForeColor="Red"> </asp:RequiredFieldValidator></td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="ls-label col-md-3">
                            Data Competição
                            <asp:TextBox ID="TextBoxData" runat="server" Class="datepicker" Width="400"></asp:TextBox>
                        </div>
                    </td>
                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Esse campo não pode ficar em branco" ControlToValidate="TextBoxData" SetFocusOnError="True" Display="Static" Font-Bold="True" ForeColor="Red"> </asp:RequiredFieldValidator></td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="ls-label col-md-3">
                            ...
                            <asp:TextBox ID="TextBoxEnCompet" runat="server" Class="datepicker" Width="400"></asp:TextBox>
                        </div>
                    </td>
                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Esse campo não pode ficar em branco" ControlToValidate="TextBoxEnCompet" SetFocusOnError="True" Display="Static" Font-Bold="True" ForeColor="Red"> </asp:RequiredFieldValidator></td>
                </tr>
            ...
            <asp:TextBox ID="TextBoxHorario" runat="server" Placeholder="12:30" Width="400"></asp:TextBox>
                    ...
                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Esse campo não pode ficar em branco" ControlToValidate="TextBoxHorario" SetFocusOnError="True" Display="Static" Font-Bold="True" ForeColor="Red"> </asp:RequiredFieldValidator></td>
                </tr>
            ...
            <asp:TextBox ID="TextBoxBairro" runat="server" Placeholder="Tirol" Width="400"></asp:TextBox>
                ...
                <tr>
                    <td><div class="ls-label col-md-3">
            CEP
            <asp:TextBox ID="TextBoxCep" runat="server" Placeholder="59065-210" AutoPostBack="true" Width="400"></asp:TextBox>
        </div></td>
        ...
        <div class="ls-label col-md-3">
            <br /><br /><br />
            <asp:Button ID="Button1" CssClass="ls-btn" runat="server" Text="Finalizar Edicao" OnClick="Editar_Click" />
        </div>
    </div>
