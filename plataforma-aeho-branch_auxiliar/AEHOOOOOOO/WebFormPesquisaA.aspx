<%@ Page Title="" Language="C#" MasterPageFile="~/MasterAtleta.Master" AutoEventWireup="true" CodeBehind="WebFormPesquisaA.aspx.cs" Inherits="AEHOOOOOOO.WebFormPesquisaA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HyperLink ID="HyperLinkAbertas" runat="server" NavigateUrl="~/WebFormCompAbertDAO.aspx" ForeColor="#6666FF">Detalhes - Competições Abertas</asp:HyperLink><br /><br />
    <asp:HyperLink ID="HyperLinkEncerradas" runat="server" NavigateUrl="~/WebFormCompEncerDAO.aspx" ForeColor="#6666FF" >Detalhes - Competições Encerradas</asp:HyperLink>
